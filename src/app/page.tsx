  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="absolute right-0 top-0 p-4 z-20">
        <Link
          href="https://github.com/kryptobesteuern/crypto-atlas"
          target="_blank"
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1 space-y-6">
              <div className="flex items-center gap-4">
                <Image
                  src="/europe-logo.svg"
                  alt="Europe Crypto Atlas Logo"
                  width={60}
                  height={60}
                  className="rounded-full"
                />
                <h1 className="text-4xl md:text-6xl font-bold">
                  <span className="text-[var(--eu-yellow)]">Crypto</span> Atlas
                </h1>
              </div>
              <p className="text-xl md:text-2xl max-w-2xl">
                Discover European crypto and blockchain services
              </p>
              <p className="text-lg opacity-80 max-w-2xl">
                Your map to navigate the European crypto landscape
              </p>
              <div className="pt-4">
                <a
                  href="#exchanges"
          ...
          <div className="md:hidden flex justify-between items-center py-2 px-4">
            <div className="flex items-center gap-2">
              <Image
                ...
                className="rounded-full"
              />
              <span className="font-bold">Crypto Atlas</span>
            </div>
            <button
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <section className="text-center max-w-3xl mx-auto mb-8 px-4 md:px-8">
            <h2 className="text-3xl font-bold mb-4">
              Welcome to the European Crypto Atlas
            </h2>
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Explore our collection of innovative European crypto and blockchain services.
              Find the perfect platforms for your cryptocurrency needs or
              discover new blockchain experiences.
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <ActionButton
                href="https://github.com/kryptobesteuern/crypto-atlas/issues/new?template=suggest-service.yml"
                icon={
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
      ...
      <footer className="bg-[var(--eu-blue)] text-white py-8 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
              ...
              <p className="mt-2 text-sm text-white/70">
                Mapping the European crypto landscape
              </p>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="mt-8 pt-6 border-t border-white/20 text-center text-sm text-white/60">
            © {new Date().getFullYear()} Crypto Atlas • GPL Licensed • Contributions
            welcome
          </div>
          <div className="mt-4 text-center text-sm text-white/60">
            Maintained by{' '}
            <a
              href="https://www.linkedin.com/in/markusbegerow"
              target="_blank"
