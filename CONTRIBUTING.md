# Contributing to Crypto Atlas

Thank you for your interest in contributing to Crypto Atlas! This document provides guidelines and instructions for contributing to this project.

## Ways to Contribute

There are several ways you can contribute to Crypto Atlas:

1. **Add new European crypto services**: Help us expand our directory by adding new services.
...
The most common contribution is adding a new European crypto service to our directory. Here's how to do it:

### Step 1: Fork the Repository

1. Click the "Fork" button at the top right of the [repository page](https://github.com/kryptobesteuern/crypto-atlas).
...
2. Push to your forked repository:
   ...
   ```
3. Go to the [original repository](https://github.com/kryptobesteuern/crypto-atlas) and click "New Pull Request".
...
Thank you for contributing to Crypto Atlas! 🇪🇺
